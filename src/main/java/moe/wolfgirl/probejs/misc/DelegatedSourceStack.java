...
public class DelegatedSourceStack extends CommandSourceStack {
    private final List<JsonObject> messageStack = new ArrayList<>();

    public DelegatedSourceStack(CommandSourceStack stack) {
        this(stack, stack.getPosition());
    }

    public DelegatedSourceStack(CommandSourceStack stack, Vec3 position) {
        this(stack, position, null);
    }

    public DelegatedSourceStack(CommandSourceStack stack, Vec3 position, @Nullable Entity executor) {
