...
public class ComponentConverter {
    public static PropertyType<?> fromDescription(TypeDescJS description) {
        if (description instanceof ArrayDescJS array) {
            ...
            if (parameterized.type() instanceof PrimitiveDescJS primitive && primitive.type().endsWith(ResourceKey.class.getName()) && parameterized.types()[0] instanceof PrimitiveDescJS registryType) {
                // If we have a ResourceKey<RegistryType>, we can use the special type generated by ProbeJS
                try {
