...
public class Manager {
    ...
    private static final String TIMESTAMP_API = "http://static.wolfgirl.moe/api/timestamp?path=probejs/docs-1.19.2.zip";
    private static final String DOWNLOAD_API = "http://static.wolfgirl.moe/object-service/checked/probejs/docs-1.19.2.zip?timestamp=%s";
