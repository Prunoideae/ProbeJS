package moe.wolfgirl.probejs.java.type;

import moe.wolfgirl.probejs.java.type.impl.ArrayType;
import moe.wolfgirl.probejs.java.type.impl.ClassType;
import moe.wolfgirl.probejs.java.type.impl.ParamType;
...
public class TypeAdapter {
    ...
    public static TypeDescriptor getTypeDescription(AnnotatedType type, boolean recursive) {
        ...
        if (type instanceof AnnotatedWildcardType wildcardType) {
            return new moe.wolfgirl.probejs.java.type.impl.WildcardType(wildcardType, recursive);
        }
