...
import moe.wolfgirl.probejs.specials.special.FormatterRegistry;
import moe.wolfgirl.probejs.util.special_docs.BlockEntityInfoDocument;
import moe.wolfgirl.probejs.util.special_docs.JavaWrapperDocument;
import moe.wolfgirl.probejs.util.special_docs.RecipeEventDocument;
import moe.wolfgirl.probejs.util.special_docs.SchemaRegistryEventJSDocument;
