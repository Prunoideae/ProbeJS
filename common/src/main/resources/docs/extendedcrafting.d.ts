...
class ExtendedCraftingRecipes {
    shaped_table(output: dev.latvian.mods.kubejs.item.ItemStackJS, pattern: string[], items: { [key: string]: dev.latvian.mods.kubejs.item.ingredient.IngredientJS }): dev.latvian.mods.kubejs.recipe.minecraft.ShapedRecipeJS;
